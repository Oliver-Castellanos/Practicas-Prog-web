...
//Validar nickname
	...
	var regex = new RegExp (/^[A-Za-z]{6,30}$/);

  	if (!regex.test(document.myform.nickname.value) || document.myform.nickname.value.length == 0)
  	{
    	document.getElementById("error_mail").style.display='block';
    	document.myform.nickname.focus();
    	return 0;
  	}
  	regex = new RegExp (/^[A-Za-z0-9!@#$%^&*()_]{6,20}$/);
//Validar email
   	if (!regex.test(document.myform.email.value) || document.myform.email.value.length == 0) {
  		document.getElementById("error_mail").style.display='block';
...
//Validar password
	regex = new RegExp (/^[A-Za-z0-9!@#$%^&*()_]{6,20}$/);
    if (!regex.test(document.myform.password.value) || document.myform.password.value.length == 0) {
  	{
    ...
    document.myform.pass_md5.value = md5(utf8_encode(document.myform.password.value));
